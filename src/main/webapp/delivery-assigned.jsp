...
.profile-info h4 { margin: 0; font-size: 1.2rem; font-weight: 600; color: #1d2671; }
.profile-info p { margin: 2px 0 0; font-size: 0.85rem; color: #555; }
...
.stat-card h5 { font-size: 0.9rem; margin: 0 0 5px; }
.stat-card h2 { font-size: 1.4rem; font-weight: 700; margin: 0; }
...
<div class="sidebar">
    ...
    <a href="delivery-assigned.jsp" class="active"><i class="bi bi-box"></i> <span>Assigned Orders</span></a>
                ...
                <tbody>
                    ...
                    if (deliveries != null && !deliveries.isEmpty()) {
                        for (Object obj : deliveries) {
                            Map d = (Map) obj;
                    %>
                    <tr onclick="location.href='delivery-order-details.jsp?order_id=<%=d.get("order_id")%>'">
                        ...
                        <td>
                            <span class="badge <%="Delivered".equals(d.get("status")) ? "badge-delivered" : "Pending".equals(d.get("status")) ? "badge-pending" : "badge-delayed"%>">
                                <%=d.get("status")%>
                            </span>
                        </td>
