          ...
          %>
            <div class="col-sm-6 col-md-4 col-lg-3" style="animation-delay: <%= delay %>;">
              <div class="product-card">
                <img src="<%= (p.getImage() != null) ? "data:image/jpeg;base64," + java.util.Base64.getEncoder().encodeToString(p.getImage()) : "https://via.placeholder.com/300x200?text=No+Image" %>"
                ...
                <div class="product-body">
                  ...
                  <p class="mb-1 text-success">
                    Discounted: 
                    <%= (p.getDiscountedPrice() != null) ? "₹" + p.getDiscountedPrice() : "Pending" %>
                  </p>
                  <p>
                    <span class="status-badge <%= p.isVerified() ? "bg-verified" : "bg-pending" %>">
                      <%= p.isVerified() ? "Verified" : "Pending Approval" %>
                    </span>
                  </p>
                </div>
              </div>
