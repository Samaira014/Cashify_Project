...
.device-card:nth-child(6) { animation-delay: 0.5s; }
    ...
    <div class="row g-3 justify-content-start">
        ...
        <div class="col-6 col-md-4 col-lg-3 col-xl-2">
            <div class="card h-100 shadow-sm border-0 product-card position-relative">
                ...
                <!-- Wishlist Heart -->
                <button class="wishlist-btn position-absolute top-0 end-0 m-2 border-0 bg-white rounded-circle p-1">
                ...
                <div class="card-body text-center py-2">
                    ...
                    <p class="text-muted mb-1"><del>₹57,799</del></p>
